...
@Composable
internal fun <T : Any> rememberOverrideSceneSetupNavEntryDecorator(): OverrideSceneSetupNavEntryDecorator<T> =
    remember {
        OverrideSceneSetupNavEntryDecorator()
    }
 ...
 */
internal class OverrideSceneSetupNavEntryDecorator<T : Any>(
    ...
    NavEntryDecorator<T>(
        ...
        decorate = { entry ->
            ...
            val entriesToExclude = LocalOverrideEntriesToExcludeFromCurrentScene.current
 ...
 */
internal val LocalOverrideEntriesToExcludeFromCurrentScene: ProvidableCompositionLocal<Set<Any>> =
    compositionLocalOf {
        HashSet()
    }
