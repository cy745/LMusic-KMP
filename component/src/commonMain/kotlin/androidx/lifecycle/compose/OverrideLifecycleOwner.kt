 ...
 */
@Composable
public fun OverrideLifecycleOwner(
    maxLifecycle: State = RESUMED,
    parent: LifecycleOwner? = LocalLifecycleOwner.current,
    content: @Composable () -> Unit,
) {
    val localLifecycleOwner = remember(parent) { OverrideComposeLifecycleOwner() }
 ...
 * state.
 */
private class OverrideComposeLifecycleOwner : LifecycleOwner {
