...
import com.lalilu.component.BottomSheetState.Companion.Saver
...
class BottomSheetState(
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith("progress(from = 0f, to = 1f)"),
    )
    ...
    suspend fun expand() {
        val target =
            if (anchoredDraggableState.anchors.hasAnchorFor(BottomSheetValue.Expanded)) {
...
fun BottomSheetScaffold(
    ...
    tonalElevation: Dp = BottomSheetScaffoldDefaults.TonalElevation,
    shadowElevation: Dp = BottomSheetScaffoldDefaults.ShadowElevation,
...
private fun BottomSheet(
    ...
    Surface(
        modifier
            .draggableAnchors(state.anchoredDraggableState, Orientation.Vertical) { sheetSize,
                                                                                    constraints ->
                ...
                val newTarget =
                    when (state.anchoredDraggableState.targetValue) {
                        ...
                        BottomSheetValue.Expanded -> if (newAnchors.hasAnchorFor(BottomSheetValue.Expanded)) BottomSheetValue.Expanded
...
object BottomSheetScaffoldDefaults {
    /** The default tonal elevation used by [BottomSheetScaffold]. */
    val TonalElevation = 8.dp

    /** The default shadow elevation used by [BottomSheetScaffold]. */
