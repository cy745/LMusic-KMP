...
xcrun simctl spawn "$LMUSIC_IOS_SIMULATOR_ID" \
    ...
    --ktest_gradle_filter=com.lalilu.lplayer.playback.AVPlayerPreparationTest,com.lalilu.lplayer.playback.MediaTimeConversionTest,com.lalilu.lplayer.playback.HistoryQueueRestorerTest,com.lalilu.lplayer.playback.IosLoadFailureTest,com.lalilu.lplayer.playback.PlaybackFailureNavigationTest,com.lalilu.lplayer.playback.LoadFailureWatchTest,com.lalilu.lplayer.playback.AVAudioPlayerEngineTest
